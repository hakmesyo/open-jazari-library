 ...
 */
package jazari.video_processing.marvin;
 ...
 * @author cezerilab
 */
public class TestMarvinVideoInterface extends JFrame implements Runnable {
    ...
    public TestMarvinVideoInterface() {
    ...
    public static void main(String[] args) {
        TestMarvinVideoInterface m = new TestMarvinVideoInterface();
