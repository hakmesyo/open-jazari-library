...
public class Denemeler {
    public static void main(String[] args) {
        //INDArray d=Nd4j.linspace(1, 10, 100).reshape(20,5);
        Nd4j.getRandom().setSeed(123);
        INDArray d=Nd4j.rand(3,2);
...
////////        
////////        String s=FactoryUtils.formatFloatAsString(1.0159973f, 3);
////////        System.out.println("s = " + s);
////////        
////////        INDArray d3=Nd4j.randn(10,10).mul(10);
////////        System.out.println("d3 = " + Nd4j.randn(1,1));
