...
/**
 * usage java HoughTransform pentagon.png JavaHoughTransform.png 640 480 100
 *
 * @author BAP1
 */
public class HoughTransformLine {
    ...
    public static void main(String[] args) throws IOException {
        ArrayData inputData = getArrayDataFromImage("images//pentagon.png");
        int minContrast = 100;
        ArrayData outputData = houghTransform(inputData, 640, 480, minContrast);
        writeOutputImage("images//pentagonHough.png", outputData);
        return;
    }
}
