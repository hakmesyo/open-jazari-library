...
public class ColorSpaceLAB {
    ...
    public ColorSpaceLAB(double L, double a, double b) {
        this.L = L;
        this.a = a;
        this.b = b;
    }

    private ColorSpaceLAB(double L, double a, double b, int c) {
        this.L = L;
        this.a = a;
        this.b = b;
        this.c = c;
    ...
    public boolean equals(Object o) {
        if (o instanceof ColorSpaceLAB) {
            ColorSpaceLAB y = (ColorSpaceLAB) o;
    ...
    public ColorSpaceLAB copy() {
        ColorSpaceLAB x = new ColorSpaceLAB(L, a, b, c);
        if (w != null) {
            x.w = w.clone();
        }
        return x;
    ...
    public double distance(ColorSpaceLAB y) {
     ...
     */
    public static ColorSpaceLAB fromRGB(int ri, int gi, int bi, double binSize) {
     ...
     */
    public static ColorSpaceLAB fromRGBr(int ri, int gi, int bi, double binSize) {
        // first, normalize RGB values
        double r = ri / 255.0;
        double g = gi / 255.0;
        double b = bi / 255.0;
    ...
    public static double ciede2000(ColorSpaceLAB x, ColorSpaceLAB y) {
