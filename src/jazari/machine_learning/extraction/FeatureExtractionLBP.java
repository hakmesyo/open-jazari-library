...
//     * @return
//     */
//    public static int[] getLBP(float[] d) {
//        int N = 8;  //8 bit
...
//    }
     ...
     */
    public static int[] getLBP(float[] d, int N, boolean isRegular) {
        int[] ret = new int[d.length];
        int[] lbp = new int[d.length];
    ...
    private static String getLBPPattern(int[][] img, int x, int y) {
        ...
        String s = "";
        float n = (float)(2 * Math.PI / 8); //for bilinear interpolation detect angle increment
        int r = 1; //radious
        float[][] spoints = new float[8][2];
        for (int i = 0; i < 8; i++) {
            spoints[i][0] = (float)-Math.sin(i * n);
            spoints[i][1] = (float)Math.cos(i * n);
        }
...
//    private static String getLBPPattern(float[] d, int x) {
//        String s = "";
...
//    }
     ...
     * @return
     */
    private static String getLBPPattern(float[] d, int x, int n) {
        String s = "";
        for (int i = n / 2; i > 0; i--) {
