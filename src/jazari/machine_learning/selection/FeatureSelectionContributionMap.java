...
public class FeatureSelectionContributionMap {
    ...
    private static Map<String, Float> getContributionMapValue(String features, String ss) {
...
//            d[i] = (float) dd[i];
//        }
//        float[] dm=FactoryNormalization.normalizeIntensity(d,0,255);
    ...
    public static ArrayList<TVoteMap> getContributionMapValueByList(String features, String s1) {
        Map<String, Float> vm=getContributionMapValue(features,s1);
