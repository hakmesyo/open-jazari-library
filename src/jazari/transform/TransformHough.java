...
public class TransformHough
{
  ...
  {
    ArrayData inputData = getArrayDataFromImage("C:\\Users\\BAP1\\Desktop\\chessboard.jpg");
    int minContrast = 32;
    ArrayData outputData = houghTransform(inputData, 640, 480, minContrast);
    writeOutputImage("C:\\Users\\BAP1\\Desktop\\transformed_chessboard.jpg", outputData);
    return;
  }
}