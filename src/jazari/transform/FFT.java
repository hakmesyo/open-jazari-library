...
/**
 * Class for computing a windowed fast Fourier transform. Implements some of the
 * window functions for the STFT from Harris (1978), Proc. IEEE, 66, 1, 51-83.
 */
public final class FFT {
     ...
     * REVERSE)
     * @throws IllegalArgumentException if the length of the input data is not a
     * power of 2
     */
     ...
     *
     * @param re the real input (power) and output (magnitude) data; length must
     * be a power of 2
     */
     ...
     * output data)
     * @param ph the phase of the spectral input data (and the imaginary part of
     * the output data)
     */
     ...
     *
     * @param re the real part of the input data and the magnitude of the output
     * data
     * @param im the imaginary part of the input data and the phase of the
     * output data
     */
