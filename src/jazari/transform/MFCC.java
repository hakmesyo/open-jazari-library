 ...
 * short overlapping frames, and for each frame, a feature vector is is
 * computed, which consists of Mel Frequency Cepstrum Coefficients.<br>
 ...
 * spectrum, and thus are a good and compact representation of the spectral
 * shape. They are widely used as features for speech recognition, and have also
 * proved useful in music instrument recognition [1].<br>
 * <br>
...
//  private double[] inputData;
     ...
     *
     * @param sampleRate float samples per second, must be greater than zero;
     * not whole-numbered values get rounded
     ...
     * @param numberCoefficients int must be grate or equal to 1 and smaller
     * than the number of filters
     * @param useFirstCoefficient boolean indicates whether the first
     * coefficient of the dct process should be used in the mfcc feature vector
     * or not
     * @throws IllegalArgumentException raised if method contract is violated
     */
     ...
     *
     * @param sampleRate float samples per second, must be greater than zero;
     * none integer values get rounded
     * @param windowSize int size of window; must be 2^n and at least 32
     * @param numberCoefficients int must be grate or equal to 1 and smaller
     * than the number of filters
     * @param useFirstCoefficient boolean indicates whether the first
...
//  }
     ...
     *
     * @param input double[] input data is an array of samples, must be a
     * multiple of the hop size, must not be a null value
